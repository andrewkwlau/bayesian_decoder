...
def plot_single_tuning(
    ...
    if save == True:
        plt.savefig(
            '../savefig/'+ mouse.mouse_ID +'_single_tuning_neuron_'+ str(neuron_idx) +'.png',
            dpi=300
        )       
    plt.show()
...
def plot_single_heatmap(
    ...
    if save == True:
        plt.savefig(
            '../savefig/'+ mouse.mouse_ID +'_single_heatmap_'+ str(neuron_idx) +'.png',
            dpi=300
        )     
    plt.show()
...
def plot_confusion_mtx(
    ...
    ax_settings = {'xlabel':'decoded position (cm)',
